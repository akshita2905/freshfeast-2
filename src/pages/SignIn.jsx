...
function SignIn() {
  ...
  const handleGoogleAuth =async () => {
      ...
      const provider = new GoogleAuthProvider() // gives pop up with mail ids both signup and signin
    ...
    <div className="min-h-screen w-full flex items-center justify-center p-4" style={{ backgroundColor: bgColor }}>
      <div className="bg-white rounded-xl shadow-lg w-full max-w-md p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="button"
            className="w-full py-2 flex items-center justify-center border rounded-md hover:bg-gray-100 transition-colors" onClick={handleGoogleAuth}
          >
